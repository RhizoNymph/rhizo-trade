...
def time_series_walk_forward_cv_xgboost_parallel(features, target, model_params, hyperparameter_grid, selected_features, poly_transform,  mode='dynamic', n_folds=5, validation_days=30, min_training_days=90, test_size=0.1, gap_days=7):
